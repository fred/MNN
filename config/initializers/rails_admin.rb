  ...
  RailsAdmin.config do |config|
    ...
    config.model Category do
      ...
      # Found columns:
        ...
        field :updated_at, :datetime   #   # Sections:
      list do; end
      export do; end
      show do; end
      edit do; end
    ...
    config.model Comment do
      # Found associations: 
        field :owner, :belongs_to_association   #   # Found columns:
        field :body, :text 
        field :created_at, :datetime 
        field :updated_at, :datetime   #   # Sections:
      list do; end
    ...
    config.model Item do
      # Found associations:
        field :user, :belongs_to_association 
        field :attachments, :has_many_association 
        field :item_stats, :has_many_association 
        field :tags, :has_and_belongs_to_many_association 
        field :region_tags, :has_and_belongs_to_many_association   #   # Found columns:
        field :title, :string 
        field :highlight, :string 
        field :body, :text 
        field :abstract, :text 
        field :editor_notes, :text 
        field :slug, :string 
        ...
        field :draft, :boolean 
        field :meta_enabled, :boolean 
        field :allow_comments, :boolean 
        field :allow_star_rating, :boolean 
        field :protected_record, :boolean 
        field :featured, :boolean 
        field :member_only, :boolean 
    ...
    config.model ItemStat do
      # Found associations:
        field :item, :belongs_to_association   #   # Found columns:
        field :views_counter, :integer   #   # Sections:
      list do; end
      export do; end
      show do; end
      edit do; end
    ...
    config.model Role do
      # Found associations:
        field :users, :has_and_belongs_to_many_association   #   # Found columns:
        field :title, :string 
        field :description, :text 
      list do; end
      export do; end
    ...
    config.model Score do
      ...
      # Found columns:
        ...
        field :scorable_type, :integer 
        field :scorable_id, :integer 
    ...
    config.model User do
      ...
      show do
        field :items, :has_many_association 
        field :attachments, :has_many_association 
        field :roles, :has_and_belongs_to_many_association   #   # Found columns:
        field :email, :string 
